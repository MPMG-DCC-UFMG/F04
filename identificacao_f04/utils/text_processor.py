...
import math
import numpy as np
print("Passei 1 em text_processor", flush=True)
from nltk.stem.snowball import SnowballStemmer
print("Passei 2 em text_processor", flush=True)
from nltk.corpus import stopwords
print("Passei 3 em text_processor", flush=True)
from gensim import corpora, matutils
print("Passei 4 em text_processor", flush=True)
import gensim
print("Passei 5 em text_processor", flush=True)
import re
from unicodedata import normalize
print("Passei 6 em text_processor", flush=True)
# import matplotlib
# matplotlib.use("agg")

print("Terminei de importar text_processor", flush=True)
