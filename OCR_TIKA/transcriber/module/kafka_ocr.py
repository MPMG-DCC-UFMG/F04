...
class Ocr(KafkaInteractor):
  ...
  def transcribe_images_in_kafka_messages(self, topic_name, obj, verbose=False):
    ...
    try:
      ...
      raise requests.exceptions.RequestException(f'{e} Falha na autenticação.')
  ...
  def __transcribe_image(self, message, obj):
    print("Chegamos no transcribe image. Isso é bom! ")
    ...
    try:
      ...
      print("Chegamos na leitura da mensagem. EU GOSTO DISSO.")
